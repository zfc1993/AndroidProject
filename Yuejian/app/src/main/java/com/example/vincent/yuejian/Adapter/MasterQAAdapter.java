...
public class MasterQAAdapter extends XRecyclerView.Adapter<XRecyclerView.ViewHolder>{
    private Context mContext;
    protected List mDataList;
    private LayoutInflater mlayoutInflater;
    public MasterQAAdapter(Context mContext, List<Actbean> mDataList){
        this.mContext = mContext;
        this.mDataList = mDataList;
        mlayoutInflater = LayoutInflater.from(mContext);
    }

    public MasterQAAdapter(Context mContext){
        this.mContext = mContext;
        mlayoutInflater = LayoutInflater.from(mContext);
    }
    ...
    public XRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = mlayoutInflater.from(parent.getContext()).inflate(R.layout.qa_item_card, parent, false);
        return new MasterQAAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(XRecyclerView.ViewHolder holder, int position) {
        ...
        if (null == entity)
            return;
        MasterQAAdapter.ViewHolder viewHolder = (MasterQAAdapter.ViewHolder) holder;
